...
var Player = function() {
	...
	this.draw = function() {
		try {
			if (this.dir == "right") this.cy = 150;
			else if (this.dir == "left") this.cy = 326;
			else if (this.dir == "right_land") this.cy = 499;
			else if (this.dir == "left_land") this.cy = 672;
...
function Platform() {
	...
	this.draw = function() {
		try {
			...
			else if (this.type == 3 && this.flag == 1) this.cy = 120;
			else if (this.type == 4 && this.state === 0) this.cy = 90;
			else if (this.type == 4 && this.state == 1) this.cy = 120;
...
var spring = function() {
	...
	this.draw = function() {
		try {
			if (this.state === 0) this.cy = 840;
			else if (this.state == 1) this.cy = 900;
